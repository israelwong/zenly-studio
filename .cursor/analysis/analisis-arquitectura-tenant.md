...
ZEN es una plataforma SaaS multi-tenant diseñada específicamente para estudios fotográficos. La arquitectura está basada en **Next.js 16**, **TypeScript 5**, **React 19**, **Prisma** y **Supabase**, con un sistema modular que permite activar/desactivar funcionalidades según el plan de suscripción.
