// components/ui/dropdown-menu.tsx (o tu ruta de componentes UI)
"use client";
...
// --- DropdownMenuSubTrigger (Para submenús) ---
...
>(({ className, inset, children, ...props }, ref) => (
    <DropdownMenuPrimitive.SubTrigger
        ...
        className={cn(
            ...
            inset && "pl-8", // Indentación si es inset
            className
        )}
        {...props}
    >
...
// --- DropdownMenuContent (Contenido principal del menú) ---
...
// --- DropdownMenuItem (Un item clickeable) ---
...
>(({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
        ref={ref}
        className={cn(
            "relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-zinc-700 focus:text-zinc-50 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
            inset && "pl-8",
            className
        )}
        {...props}
...
>(({ className, children, checked, ...props }, ref) => (
    <DropdownMenuPrimitive.CheckboxItem
        ref={ref}
        className={cn(
            "relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-colors focus:bg-zinc-700 focus:text-zinc-50 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
            className
        )}
        checked={checked}
        {...props}
...
// --- DropdownMenuRadioItem (Item tipo radio) ---
...
// --- DropdownMenuLabel (Etiqueta no clickeable) ---
...
// --- DropdownMenuShortcut (Para mostrar atajos de teclado) ---
