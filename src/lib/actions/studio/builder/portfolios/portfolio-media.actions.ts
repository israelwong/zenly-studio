...
export async function deletePortfolioMedia(mediaId: string) {
    try {
        ...
        if (media.portfolio.studio.slug) {
            revalidatePath(`/${media.portfolio.studio.slug}/studio/builder/content/portfolios`);
            revalidatePath(`/${media.portfolio.studio.slug}/studio/builder/content/portfolios/${media.portfolio.id}`);
        }
...
export async function reorderPortfolioMedia(mediaIds: string[]) {
    try {
        ...
        if (firstMedia?.portfolio.studio.slug) {
            revalidatePath(`/${firstMedia.portfolio.studio.slug}/studio/builder/content/portfolios`);
            revalidatePath(`/${firstMedia.portfolio.studio.slug}/studio/builder/content/portfolios/${firstMedia.portfolio.id}`);
        }
