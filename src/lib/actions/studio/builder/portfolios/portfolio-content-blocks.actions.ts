...
export async function createPortfolioContentBlock(
    ...
    try {
        ...
        if (portfolio?.studio.slug) {
            ...
            revalidatePath(`/${portfolio.studio.slug}/studio/builder/content/portfolios/${portfolioId}`);
        }
...
export async function updatePortfolioContentBlock(
    ...
    try {
        ...
        if (existingBlock.portfolio.studio.slug) {
            revalidatePath(`/${existingBlock.portfolio.studio.slug}/studio/builder/content/portfolios`);
            revalidatePath(`/${existingBlock.portfolio.studio.slug}/studio/builder/content/portfolios/${existingBlock.portfolio.id}`);
        }
...
export async function deletePortfolioContentBlock(blockId: string) {
    try {
        ...
        if (block.portfolio.studio.slug) {
            revalidatePath(`/${block.portfolio.studio.slug}/studio/builder/content/portfolios`);
            revalidatePath(`/${block.portfolio.studio.slug}/studio/builder/content/portfolios/${block.portfolio.id}`);
        }
