        ...
        const portfolio = await prisma.$transaction(async (tx) => {
            ...
            const newPortfolio = await tx.studio_portfolios.create({
                data: {
                    ...
                    cta_enabled: validatedData.cta_enabled ?? true,
                    cta_text: validatedData.cta_text || "Cotiza tu evento",
                    cta_action: validatedData.cta_action || "whatsapp",
    ...
    try {
        ...
        const portfolio = await prisma.studio_portfolios.update({
            ...
            data: {
                ...
                cta_link: validatedData.cta_link ?? undefined,
