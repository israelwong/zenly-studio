...
import {
  ...
  type SecuritySettingsForm as SecuritySettingsFormType,
} from '@/lib/actions/schemas/seguridad/seguridad-schemas';
import {
  obtenerConfiguracionesSeguridad,
  actualizarConfiguracionesSeguridad,
} from '@/lib/actions/studio/account/seguridad/seguridad.actions';
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 flex-1 flex flex-col">
          <div className="flex items-center justify-between p-4 bg-zinc-800/50 rounded-lg">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" {...register('email_notifications')} className="sr-only peer" />
          ...
          <div className="flex items-center justify-between p-4 bg-zinc-800/50 rounded-lg">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" {...register('device_alerts')} className="sr-only peer" />
              <div className="w-11 h-6 bg-zinc-700 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600" />
            </label>
          </div>
          ...
          <div className="p-4 bg-zinc-800/50 rounded-lg">
            ...
            <div className="mb-4 pl-8">
              <p className="text-zinc-500 text-xs">
                • Tu sesión se cerrará automáticamente después de {sessionTimeout} minutos sin actividad
                <br />
                • Recibirás una advertencia 5 minutos antes
                <br />• Cualquier interacción reinicia el contador
              </p>
            </div>
            <div className="flex items-center gap-4">
              <input
                ...
                className="flex-1 h-2 bg-zinc-700 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-blue-500 [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:cursor-pointer"
                style={{
              ...
              />
              <div className="text-white font-medium min-w-[4rem] text-center">{sessionTimeout} min</div>
            </div>
