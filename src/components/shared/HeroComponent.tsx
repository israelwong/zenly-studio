...
export default function HeroComponent({
    ...
    const layoutClasses = {
        fullwidth: '',
        wrapped: 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'
    };
    ...
    return (
        <div className={`relative min-h-[50vh] sm:min-h-[60vh] flex ${verticalAlignmentClasses[verticalAlignment]} justify-center overflow-hidden bg-zinc-900 ${className}`}>
            {/* Fallback Background */}
            ...
            {/* Content */}
            <div className={`relative z-10 w-full ${layoutClasses[layout]} ${layout === 'fullwidth' ? 'px-4 sm:px-6' : ''}`}>
                <div className={`max-w-3xl mx-auto ${textAlignmentClasses[textAlignment]}`}>
                    {/* Subtitle */}
                    {subtitle && (
